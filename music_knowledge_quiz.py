...
def main():
    ...
    ss['userpd'] = st.text_input('Enter your password for full access or find Max for password:', on_change=password_entered,label_visibility=ss["pw_visible"],disabled = ss["pw_dis"])
